...
This is default sapper app scafolded. It also includes Cypress for e2e testing.

## Installation

Here we describe all steps required to create this project.

```bash
# scafold the project based on sapper rollup template
npx degit "sveltejs/sapper-template#rollup" sapper-app

```

## Official documentation sapper-template
